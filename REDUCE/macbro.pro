...
if n_params() lt 3 then begin
  print,'syntax: snew=macbro(w,sold,hwhm)'
  retall
endif
...
;  sqrt(alog(2.0)/pi)=0.46971864 (*1.0000632 to correct for >4 sigma wings)
  nhalf = abs(fix(3.3972872 * hwhm/dw))		;# points in half gaussian
  ng = 2 * nhalf + 1				;# points in gaussian (odd!)
  wg = dW * (findgen(nG) - (ng-1)/2.0)		;wavelength scale of gaussian
  xg = (0.83255461 / hwhm) * wg 		;convenient absisca
  gpro = (0.46974832 * dw / hwhm) * exp(-xg*xg)	;unit area gaussian w/ FWHM
